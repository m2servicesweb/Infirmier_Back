...
function register_rest_invite_friend_route() {
	register_rest_route(
		'infirmier_boutet/v1', '/invite-friend', [
			'methods'  => 'POST',
...
function send_friend_invitation( $request ) {
	 ...
	 */
	$email_status = wp_mail($email, 'Invitation infirmier_boutet', 'Vous avez reçu une invitation à rejoindre <a href="">infirmier_boutet</a>.');
